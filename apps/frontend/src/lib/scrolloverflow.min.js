...
!(function (r, n, p) {
        ...
        (e.momentum = function (t, i, s, e, o, n) {
          ...
          return (
            ...
            (r = t + ((l * l) / (2 * n)) * (a < 0 ? -1 : 1)) < e
              ? ((r = o ? e - (o / 2.5) * (l / 8) : e), (h = (a = p.abs(r - t)) / l))
              : 0 < r && ((r = o ? (o / 2.5) * (l / 8) : 0), (h = (a = p.abs(t) + r) / l)),
          ...
          elastic: {
            ...
            fn: function (t) {
              return 0 === t
                ...
                : 1 == t
                ? 1
                : 0.4 * p.pow(2, -10 * t) * p.sin(((t - 0.055) * (2 * p.PI)) / 0.22) + 1
            },
          },
        }),
        (e.tap = function (t, i) {
    ...
    if (
      ...
      this.options.interactive &&
        (this.options.disableTouch ||
          (m.addEvent(this.indicator, 'touchstart', this), m.addEvent(r, 'touchend', this)),
        this.options.disablePointer ||
          (m.addEvent(this.indicator, m.prefixPointerEvent('pointerdown'), this),
          m.addEvent(r, m.prefixPointerEvent('pointerup'), this)),
        this.options.disableMouse ||
          (m.addEvent(this.indicator, 'mousedown', this), m.addEvent(r, 'mouseup', this))),
      this.options.fade)
    ) {
  ...
  ;(t.prototype = {
    ...
    _start: function (t) {
      ...
      if (this.enabled && (!this.initiated || m.eventType[t.type] === this.initiated)) {
        !this.options.preventDefault ||
          m.isBadAndroid ||
          m.preventDefaultException(t.target, this.options.preventDefaultException) ||
          t.preventDefault()
        var i,
            ...
            if (
              ...
              ;(this.currentPage = c),
                (a =
                  ...
                  p.max(p.max(p.min(p.abs(o - c.x), 1e3), p.min(p.abs(n - c.y), 1e3)), 300)),
                (o = c.x),
                (n = c.y),
                (this.directionX = 0),
                (this.directionY = 0),
    ...
    scrollTo: function (t, i, s, e) {
      ...
      !s || o
        ? (o && (this._transitionTimingFunction(e.style), this._transitionTime(s)),
          this._translate(t, i))
    ...
    scrollToElement: function (t, i, s, e, o) {
      if ((t = t.nodeType ? t : this.scroller.querySelector(t))) {
        ...
        ;(n.left -= this.wrapperOffset.left),
          ...
          (i =
            null == i || 'auto' === i ? p.max(p.abs(this.x - n.left), p.abs(this.y - n.top)) : i),
    ...
    getComputedPosition: function () {
      ...
      return (
        (i = this.options.useTransform
          ? ((t = +((s = s[m.style.transform].split(')')[0].split(', '))[12] || s[4])),
            +(s[13] || s[5]))
    ...
    goToPage: function (t, i, s, e) {
      ...
      ;(s =
        void 0 === s
          ? this.options.snapSpeed ||
            p.max(p.max(p.min(p.abs(o - this.x), 1e3), p.min(p.abs(n - this.y), 1e3)), 300)
          : s),
      ...
      updatePosition: function () {
        ...
        this.options.ignoreBoundaries ||
          (t < this.minBoundaryX
            ...
            ? (t =
                'scale' == this.options.shrink
                  ? ((this.width = p.max(this.indicatorWidth - (t - this.maxPosX), 8)),
                    (this.indicatorStyle.width = this.width + 'px'),
          ...
          i < this.minBoundaryY
            ...
            ? (i =
                'scale' == this.options.shrink
                  ? ((this.height = p.max(this.indicatorHeight - 3 * (i - this.maxPosY), 8)),
                    (this.indicatorStyle.height = this.height + 'px'),
      ...
      function r() {
        ...
        function t(t) {
          if (!fp_utils.hasClass(t, 'fp-noscroll')) {
            ...
            null != h
              ? (i = o.scrollHeight(t))
              : ((i = t.scrollHeight), p.options.verticalCentered && (i = f(u, t)[0].scrollHeight))
      ...
      var f = null,
        ...
        a = {
          ...
          init: function (t) {
            ;(f = fp_utils.$), (h = t)
            var i =
              'ontouchstart' in l || 0 < navigator.msMaxTouchPoints || navigator.maxTouchPoints
            return (
              (a.iscrollOptions.click = i),
              (a.hasBeenInit = !0),
              (a.iscrollOptions = fp_utils.deepExtend(a.iscrollOptions, t.scrollOverflowOptions)),
          ...
          isScrolled: function (t, i) {
            ...
            if ('bottom' === t) {
              ...
              return (
                (a.lastScrollY = s.y),
                (e ? 1 : 0) + (0 - s.y) + fp_utils.getScrollTop(i) + i.offsetHeight >=
                  i.scrollHeight
              )
            }
          },
