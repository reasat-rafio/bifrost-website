...
export const Secondary: React.FC<ProjectProps> = ({
  title,
  subtitle,
  ctaButton,
  description,
  ...
  return (
    <article className="relative flex flex-col justify-end">
      <figure className="lg:absolute top-1/2 lg:-translate-y-1/2 right-0 | xl:w-[55%] lg:w-[70%] w-full | max-h-[450px] rounded-2xl | overflow-hidden">
        <SanityImg
      ...
      <section className="mr-auto | lg:translate-y-0 -translate-y-[5%] | px-2 lg:px-0">
