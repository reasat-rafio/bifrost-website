      ...
      <GradientBorder padding={false}>
        ...
        >
          ...
          <div>
            <textarea
              disabled={formSate === "submitting"}
              className="text-gray-700 w-full appearance-none rounded-lg border border-[#43434A] bg-[#09090D] py-4 px-5 leading-tight text-white focus:outline-none focus:ring-0 focus-visible:ring-1 focus-visible:ring-teal lg:py-6"
              id="message"
