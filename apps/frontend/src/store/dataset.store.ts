...
const useDatasetStore = create(
  devtools<IDatasetStore>((set) => ({
    ...
    setSelectedTaskType: (selectedTaskType) => set((state) => ({ ...state, selectedTaskType })),
    setSelectedCatagory: (selectedCategory) => set((state) => ({ ...state, selectedCategory })),
    ...
    setAllCategories: (allCategories) => set((state) => ({ ...state, allCategories })),
    setAllLabelFormat: (allLabelFormat) => set((state) => ({ ...state, allLabelFormat })),
    setAllTaskTypes: (allTaskTypes) => set((state) => ({ ...state, allTaskTypes })),
  })),
)
